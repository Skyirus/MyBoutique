...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     * @Assert\NotBlank(message="Vous devez renseigner votre mot de pass")
     * Assert\Regex(
     *      pattern="#(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).{8,}#",
     *      match="true",
     *      message="Le mot de passe doit contenir au moins un chiffre, au moins un lettre minuscule, majuscule et faire au min 8 caractaires",groups={"registration"}
     * )
     */
    private $password;

    /**
     * Assert\NotBlank(message="Vous devez renseigner la confirmation de votre mot de pass",groups={"registration"})
     * @Assert\EqualTo(
     ...
     *      pattern="#(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z]).{8,}#",
     *      match="true",
     *      message="Le mot de passe doit contenir au moins un chiffre, au moins un lettre minuscule, majuscule et faire au min 8 caractaires"
     * )
     */
     ...
     *      min = 2,
     *      max = 50,
     *      minMessage = "Votre prénom de pass doit contenir au min {{ limit }} characters",
     *      maxMessage = "Votre prénom de pass ne doit contenir plus de {{ limit }} characters",groups={"registration"}
     * )
     */
    private $firstName;
     ...
     *      min = 2,
     *      max = 50,
     *      minMessage = "Votre nom de pass doit contenir au min {{ limit }} characters",
     *      maxMessage = "Votre nom de pass ne doit contenir plus de {{ limit }} characters",groups={"registration"}
     * )
     */
    private $lastName;
